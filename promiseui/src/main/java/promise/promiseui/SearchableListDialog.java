...
public class SearchableListDialog<T extends Searchable> extends DialogFragment implements
        SearchView.OnQueryTextListener, SearchView.OnCloseListener {

    private static final String SEARCHABLES = "searchables";
    ...
    public static <T extends Searchable> SearchableListDialog newInstance(List<T> items) {
        SearchableListDialog multiSelectExpandableFragment = new
                SearchableListDialog();

        Bundle args = new Bundle();
        args.putSerializable(SEARCHABLES, (Serializable) items);
    ...
    private void setData(View rootView) {
        ...
        List items = (List) getArguments().getSerializable(SEARCHABLES);
...
//        listAdapter.filterData(s);
        ...
        else ((ArrayAdapter) _listViewItems.getAdapter()).getFilter().filter(s);
        if (null != _onSearchTextChanged) _onSearchTextChanged.onSearchTextChanged(s);
        return true;
    }
