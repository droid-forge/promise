...
public class Base64 {
   ...
   * @param srcOffset   the getIndex where conversion begins
   * @param numSigBytes the number of significant bytes in your array
   * @param destination the array to hold the conversion
   * @param destOffset  the getIndex where output will be put
  ...
  private static byte[] encode3to4(
    ...
    // --------|    ||    ||    ||    | Six bit groups to getIndex ALPHABET
...
//        }
  ...
  public static byte[] decode(byte[] source, int off, int len, int options)
    ...
    for (i = off; i < off + len; i++) {  // Loop through source
      ...
      else throw new java.io.IOException(String.format(
...
// end while: reading input
  ...
  public static Object decodeToObject(
    ...
    try {
      ...
      if (loader == null) ois = new java.io.ObjectInputStream(bais);

        // Else make a customized object input stream that uses
        // the provided class loader.
      else ois = new java.io.ObjectInputStream(bais) {
        @Override
...
// end else: no custom class loader
  ...
  public static byte[] decodeFromFile(String filename)
    ...
    try {
      ...
      }   // end if: file too big for int getIndex
      ...
      if (position < 0) {
        ...
        // Else decoding
          ...
          if (i == 4) {
            ...
            if (i == 0) return -1;
            else throw new java.io.IOException("Improperly padded Base64 input.");
