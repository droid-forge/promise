...
import promise.data.net.net.Converter;
import promise.data.net.net.FastParserEngine;
import okhttp3.RequestBody;
import okhttp3.ResponseBody;
/**
 * A {@linkplain promise.data.net.net.Converter.Factory converter} which uses Gson for JSON.
 * <p>
 * Because Gson is so flexible in the types it supports, this converter assumes that it can handle
 * all types. If you are mixing JSON serialization with something else (such as protocol buffers),
 * you must {@linkplain promise.data.net.net.FastParserEngine.Builder#addConverterFactory(promise.data.net.net.Converter.Factory) add this instance}
