...
public class SearchableSpinner extends AppCompatSpinner implements View.OnTouchListener,
    ...
    public int getSelectedItemPosition() {
        if (!TextUtils.isEmpty(_strHintText) && !_isDirty) return NO_ITEM_SELECTED;
        else return super.getSelectedItemPosition();
    }

    @Override
    public Object getSelectedItem() {
        if (!TextUtils.isEmpty(_strHintText) && !_isDirty) return null;
