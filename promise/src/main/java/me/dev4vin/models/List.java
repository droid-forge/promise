...
import me.dev4vin.models.function.BIConsumer;
import me.dev4vin.models.function.Combiner;
import me.dev4vin.models.function.FilterFunction;
import me.dev4vin.models.function.FilterFunction2;
import me.dev4vin.models.function.GroupFunction;
import me.dev4vin.models.function.GroupFunction2;
import me.dev4vin.models.function.GroupFunction3;
import me.dev4vin.models.function.JoinFunction;
import me.dev4vin.models.function.MapFunction;
import me.dev4vin.models.function.ReduceFunction;
import me.dev4vin.models.function.SearchFunction;
...
public class List<T> extends ArrayList<T> {
  ...
  @Nullable
  public T find(FilterFunction<T> function) {
    return filter(function).first();
  }

  public int findIndex(FilterFunction<T> function) {
    int match = 0;
    for (T t : this) {
  ...
  public boolean anyMatch(FilterFunction<T> function) {
    boolean match = false;
    for (T t : this)
  ...
  public List<T> filter(FilterFunction<T> function) {
    List<T> list = new List<>();
