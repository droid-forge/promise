package promise.app.ui.widget.todo
...
/**
 * The configuration screen for the [TodoWidget] AppWidget.
 */
class TodoWidgetConfigureActivity : Activity() {
  ...
  public override fun onCreate(icicle: Bundle?) {
    ...
    mAppWidgetText!!.setText(loadTitlePref(this@TodoWidgetConfigureActivity, mAppWidgetId))
  }

  companion object {

    private val PREFS_NAME = "promise.app.ui.widget.todo.TodoWidget"
