...
class AppSliceProvider : SliceProvider() {
  /**
  ...
  /**
   * Converts URL to content URI (i.e. content://promise.app.slice...)
   */
  ...
  override fun onSlicePinned(sliceUri: Uri?) {
    ...
    // trigger AppSliceProvider#onBindSlice(Uri) again.
  }
